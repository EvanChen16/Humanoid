...
#                 hex_values = [format(byte, '02X') for byte in line]
#                 print("Received Data:", hex_values)
...
while True:
    ...
    sensorsetpackage[0] = 0x53
    sensorsetpackage[1] = 0x54
    sensorsetpackage[2] = 0xF2
    sensorsetpackage[3] = 0x33
    sensorsetpackage[4] = 0x33
