...
#include "tku_msgs/srv/detail/set_string__rosidl_typesupport_fastrtps_c.h"
...
using _SetString_Request__ros_msg_type = tku_msgs__srv__SetString_Request;
...
size_t get_serialized_size_tku_msgs__srv__SetString_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetString_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tku_msgs__srv__SetString_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tku_msgs
size_t max_serialized_size_tku_msgs__srv__SetString_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tku_msgs__srv__SetString_Request;
    is_plain =
      (
...
static size_t _SetString_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tku_msgs__srv__SetString_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tku_msgs, srv, SetString_Request)() {
...
using _SetString_Response__ros_msg_type = tku_msgs__srv__SetString_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tku_msgs
size_t get_serialized_size_tku_msgs__srv__SetString_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetString_Response__ros_msg_type * ros_message = static_cast<const _SetString_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tku_msgs__srv__SetString_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tku_msgs
size_t max_serialized_size_tku_msgs__srv__SetString_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tku_msgs__srv__SetString_Response;
    is_plain =
      (
      offsetof(DataType, data) +
      last_member_size
...
static size_t _SetString_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tku_msgs__srv__SetString_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tku_msgs, srv, SetString_Response)() {
...
// already included above
// #include "tku_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "tku_msgs/srv/set_string.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tku_msgs, srv, SetString)() {
